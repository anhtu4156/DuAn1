					...
					<div class="col-12 col-sm-9 col-md-9">
						...
						<div class="row">
							<div class="col-sm-12 col-md-12">
								...
								<p class="subheading">Vui lòng nhập tên, địa chỉ email, số điện thoại của bạn để bắt đầu.</p>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12 col-md-12">
								...
								<p>Hiển thị <strong class="text-black">1-2</strong> trong 15 sản phẩm</p>
								<div class="spacer-30"></div>
							</div>
						</div>
