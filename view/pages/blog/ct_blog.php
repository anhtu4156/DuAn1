				...
				<div class="row">
					...
					<div class="col-12 col-sm-9 col-md-9">
						...
						<div class="single-news">
							<div class="media">
								<img src="images/blog-preview-img.jpg" alt="" class="img-fluid">
							</div>
							<h2 class="title"> Dog sitting on the floor </h2>
						...
						<div class="comments-box">
							...
							<div class="media comment">
								<img class="mr-3" alt="80x80" src="images/testimony-thumb-1.jpg" style="width: 64px; height: 64px;">
							...
							<div class="media reply-comment">
								<img class="mr-3" alt="80x80" src="images/testimony-thumb-2.jpg" style="width: 64px; height: 64px;">
								<div class="media-body">
									<h5 class="media-heading mt-0 mb-1">Susi Doel<small class="date">August 24, 2014</small>
	                                </h5> 
							      Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
							...
							<div class="media comment">
	                            <img class="mr-3" alt="80x80" src="images/testimony-thumb-3.jpg" style="width: 64px; height: 64px;">
								<div class="media-body">
									<h5 class="media-heading mt-0 mb-1">Susi Doel<small class="date">August 24, 2014</small>
	                                </h5> 
							      Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
						...
						<div class="leave-comment-box">
							<h4 class="title-heading">Để Lại Bình Luận</h4>
							<form action="#" class="form-comment">
								<div class="row">
									<div class="col-xs-12 col-md-6">
										<div class="form-group">
											<input type="text" id="name" name="name" value="" class="inputtext form-control" placeholder="Nhập Tên của bạn">
										</div>
									</div>
									<div class="col-xs-12 col-md-6">
										<div class="form-group">
									...
									<div class="col-xs-12 col-md-12">
										<div class="form-group">
											<input type="text" id="name" name="name" value="" class="inputtext form-control" placeholder="Nhập Trang Web">
										</div>
									</div>
									<div class="col-xs-12 col-md-12">
										<div class="form-group">
											<textarea id="message" name="message" class="inputtext form-control" rows="6" placeholder="Nhập Tin Nhắn Của Bạn..."></textarea>
										</div>
									</div>
									<div class="col-xs-12 col-md-12">
										<div class="form-group">
											<button id="send" type="submit" class="btn btn-primary">Gửi Bình Luận</button>
										</div>
									</div>
								</div>
							</form>
