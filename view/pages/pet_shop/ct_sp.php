				...
				<div class="row">
					...
					<div class="col-12 col-sm-6 col-md-6">
						<div class="single-shop">
							...
							<a href="#" class="btn btn-primary mt-4 mb-4">Mua ngay</a>
					...
					<div class="col-12 col-sm-12 col-md-12">
						...
						<div class="rs-tabs">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
							  ...
							  <li class="nav-item">
							    <a class="nav-link" id="information-tab" data-toggle="tab" href="#information" role="tab" aria-controls="information" aria-selected="false">Thông tin thêm</a>
							  </li>
							  <li class="nav-item">
							    <a class="nav-link" id="review-tab" data-toggle="tab" href="#review" role="tab" aria-controls="review" aria-selected="false">Đánh giá (3)</a>
							  </li>
							</ul>
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade" id="information" role="tabpanel" aria-labelledby="information-tab">
									...
									<ul>
										<li>Product Dimensions: 24 x 16.8 x 14.5 inches.</li>
										<li>Shipping Weight: 5.8 pounds.</li>
										<li>Domestic Shipping: Item can be shipped within U.S.</li>
										<li>International Shipping: This item can be shipped to select countries outside of the U.S.</li>
										<li>Shipping Advisory: This item must be shipped separately from other items in your order. Additional shipping charges will not apply.</li>
										<li>Item model number: 294144.</li>
									</ul>
								</div>
								<!-- Tabs 3 -->
						...
						<div class="leave-comment-box">
							<h4 class="title-heading">Đánh giá của bạn</h4>
							<div class="row">
										...
										<div class="row">
											<div class="col-xs-12 col-md-12">
												<div class="form-group">
													<textarea id="message" name="message" class="inputtext form-control" rows="6" placeholder="Đánh giá của bạn*..."></textarea>
												</div>
											</div>
											<div class="col-xs-12 col-md-6">
												<div class="form-group">
													<input type="text" id="name" name="name" value="" class="inputtext form-control" placeholder="Nhập tên">
												</div>
											</div>
											<div class="col-xs-12 col-md-6">
												<div class="form-group">
													<input type="text" id="name" name="name" value="" class="inputtext form-control" placeholder="Nhập email">
												</div>
											</div>
											<div class="col-xs-12 col-md-12">
												<div class="form-group">
													<button id="send" type="submit" class="btn btn-primary">Gửi đánh giá</button>
												</div>
											</div>
										</div>
									</form>
						...
						<div class="similar-box">
							<h4 class="title-heading">Sản phẩm tương tự</h4>
							<div class="row">
