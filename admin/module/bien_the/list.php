                        ...
                        <div class="">
                            <div class="flex flex-wrap justify-between">
                                <div class="items-center ">
                                    <h1 class="font-medium text-3xl block dark:text-slate-100">Biến thể</h1>
                    ...
                    <div class="w-full relative mb-4">
                        <div class="flex-auto p-0 md:p-4">
                            ...
                            <div class="flex flex-wrap gap-4 mb-3">
                                ...
                                <div>
                                    <a href="index.php?act=add_bien_the">
                                                ...
                                                <table class="w-full">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($bt as $items) {
                                                            ...
                                                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                <span class="text-brand-500 ">' . $id_dv . '</span>
                                                            </td>
                                                            ...
                                                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                            <span class="bg-green-600/5 text-green-600 text-[11px] font-medium px-2.5 py-0.5 rounded h-5">' . $gia . '</span>
                                                            </td>
                                                           
                                                            <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                <a href="index.php?act=sua_bt&id_bt=' . $id . '" class="me-3"><i class="icofont-ui-edit text-lg text-gray-500 dark:text-gray-400"></i></a>
                                                                <a href="index.php?act=xoa_bt&id_bt=' . $id . '" onclick=\'return confirm("Bạn có chắc chắn muốn xóa")\'><i class="icofont-ui-delete text-lg text-red-500 dark:text-red-400"></i></a>
                                                            </td>
                                                        </tr>
                                                            ';
                                                        };
