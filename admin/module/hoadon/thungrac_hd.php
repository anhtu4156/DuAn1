                        ...
                        <div class="">
                            <div class="flex flex-wrap justify-between">
                                <div class="items-center ">
                                    <h1 class="font-medium text-3xl block dark:text-slate-100">Thùng rác</h1>
                                    <ol class="list-reset flex text-sm">
                                        <li><a href="index.php" class="text-gray-500 dark:text-slate-400">Trang chủ</a></li>
                                        <li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
                                        <li class="text-gray-500 dark:text-slate-400">Admin</li>
                                        <li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
                                        <li class="text-primary-500 hover:text-primary-600 dark:text-primary-400">Thùng rác</li>
                                    </ol>
                                </div>
                            ...
                            <div class="mb-4 border-b border-gray-200 dark:border-slate-700" data-fc-type="tab">
                                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" aria-label="Tabs">
                                    <li class="me-2" role="presentation">
                                        <button class="inline-block p-4 rounded-t-lg border-b-2 active " id="all-tab" data-fc-target="#all" type="button" role="tab" aria-controls="all" aria-selected="false">All <span class="text-slate-400">(<?php foreach ($counthd as $dem) {
                                                                                                                                                                                                                                                        extract($dem);
                                                                                                                                                                                                                                                        echo $sl;
                                                                                                                                                                                                                                                    } ?>)</span></button>
                                    </li>
                                                ...
                                                <table class="w-full">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <?php
                                                            if ($trang_thai_tt == 1) {
                                                                echo '<span class="bg-green-600/5 text-green-600 text-[11px] font-medium px-2.5 py-0.5 rounded h-5">Đã thanh toán</span>';
                                                            } else {
                                                                echo '<span class="bg-red-600/5 text-red-600 text-[11px] font-medium px-2.5 py-0.5 rounded h-5">Chưa thanh toán</span>';
                                                            }
                                                            ?>
                                                        <?php
                                                            echo '
                                                                    ...
                                                                    <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <a class="me-2" href="index.php?act=khoiphuc_hd&id_hd='.$id.'" onclick=\'return confirm("Bạn có chắc chắn muốn khôi phục cho nhân viên này không?")\'><i class="icofont-arrow-left text-2xl text-red-500 dark:text-red-400"></i></a>
                                                                    <a href="index.php?act=xoa_hd_vv&id_hd=' . $id . '" onclick=\'return confirm("Bạn có chắc chắn muốn xóa vĩnh viễn order này không")\'><i class="icofont-ui-delete text-lg text-red-500 dark:text-red-400"></i></a>
                                                                    </td>
                                                                </tr>';
                                                        }
                                                        ?>
