                    ...
                    <div class="w-full relative mb-4">
                        <div class="flex-auto p-0 md:p-4">
                            ...
                            <div id="myTabContent">
                                ...
                                <!-- nhân viên -->
                                <div class="active p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="new" role="tabpanel" aria-labelledby="new-tab">
                                    <div>
                                            ...
                                            <div class="relative overflow-x-auto block w-full sm:px-6 lg:px-8">
                                                <table class="w-full">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                        foreach ($tk_nv as $tk) {
                                                            // Sử dụng extract để tạo các biến khác từ mảng $tk
                                                            extract($tk);
