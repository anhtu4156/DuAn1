                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            echo '
                                                                    ...
                                                                    <a href="index.php?act=xoa_order&id_order=' . $id . '" onclick=\'return confirm("Bạn có chắc chắn muốn xóa vào thùng rác")\'><i class="icofont-ui-delete text-lg text-red-500 dark:text-red-400"></i></a>
                                                                    </td>
                                                                </tr>';
                                                        }
                                                        ?>
