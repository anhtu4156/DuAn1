                    ...
                    <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-6 xl:col-span-6">
                        <div class="w-full relative mb-4">
                            <div class="flex-auto p-0 md:p-4">
                                ...
                                <div class="">
                                    <input name="them" type="submit" value="Thêm dịch vụ" class="px-2 py-2 lg:px-4 bg-brand  text-white text-sm  rounded hover:bg-brand-600 border border-brand-500"></input>
                                ...
                                if (isset($thanhcong) && ($thanhcong != "")) {
                                    echo "<div class='p-2 text-1xl bg-green w-[250px] text-center text-white text-sm  rounded transition hover:bg-green-600 hover:text-white border border-green font-medium'>Thêm thành công</div>";
                                }
