                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            echo '
                                                                    ...
                                                                    <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <a class="me-2" href="index.php?act=khoiphuc_order&id_order='.$id.'" onclick=\'return confirm("Bạn có chắc chắn muốn khôi phục cho nhân viên này không?")\'><i class="icofont-arrow-left text-2xl text-red-500 dark:text-red-400"></i></a>
                                                                    <a href="index.php?act=xoa_ordervv&id_order=' . $id . '" onclick=\'return confirm("Bạn có chắc chắn muốn xóa vĩnh viễn order này không")\'><i class="icofont-ui-delete text-lg text-red-500 dark:text-red-400"></i></a>
                                                                    </td>
                                                                </tr>';
                                                        }
                                                        ?>
